                      ...
                      children: [
                        Text(
                          ...
                          style: TextStyle(
                              ...
                              color: Color(widget.course.knowledge.value!.color)
                            ),
                        ),
                        SizedBox(
                          width: 18.w,
                            ...
                            children: [
                              ListView.separated(
                                  separatorBuilder: (context, index) {
                                    return Divider(color: Color(0xFFE4E6E9),);
                                  },
                                shrinkWrap: true,
                                    ...
                                    children: [
                                      ListTile(
                                        ...
                                        onTap: () {
                                          setState(() {
                                            ...
                                            _bodyWidget = SubjectMainPage(subject: currentSubject);
                                          });
                                        },
                                      ),
                                      Visibility(
                                                  ...
                                                  children: [
                                                    ListTile(
                                                      ...
                                                      leading: Stack(
                                                        ...
                                                        children: [
                                                          VerticalDivider(color: currentLesson.isCompleted?Color(0xFF62FFB8):Color(0xFFE4E6E9),
                                                            thickness: 3.w,
                                                  ...
                                                  ListTile(
                                                    ...
                                                    title: Row(
                                                      children: [
                                                        ...
                                                        SizedBox(width: 14.w,),
                                                        Text('תרגול - ${currentLesson.name}', style: TextStyle(
                                                    ...
                                                    leading: Stack(
                                                      alignment: AlignmentDirectional.center,
                                                      children: [
                                                        VerticalDivider(color: Color(0xFFE4E6E9),thickness: 3.w,),
                                                        currentSubject.lessons.isNotEmpty &&
                                                            currentSubject.lessons.last.isCompleted?
                                      ...
                                      Visibility(
                                        ...
                                        child: GestureDetector(
                                            onTap: () => setState(() {
                                              _bodyWidget = QuestionnaireWidget(
                                                  title:  'תרגול מסכם - ${widget.course.title}',
                                                  questionnaires:
